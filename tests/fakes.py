...
One instance carries both call surfaces — ``interactions`` for the teacher,
``models`` for the miner — off a single script; a test that needs both installs
...
class FakeInteractions:
    """``client.interactions`` — the teacher's call surface."""
...
class FakeModels:
    """``client.models`` — the miner's, which the cheap tier forced it onto."""
